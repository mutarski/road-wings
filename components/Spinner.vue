<template>
  <svg
    ...
    xml:space="preserve"
  >
    <line class="line-1" x1="430" y1="120" x2="20" y2="120" />
    <line class="line-2" x1="430" y1="280" x2="0" y2="280" />
    <path
      d="M410.689,235.919c-14.154,0-27.443,3.744-38.96,10.268l-20.528-27.251c26.069-19.054,52.85-27.796,55.161-28.526
    ...
    />
    <line class="line-floor" x1="500" y1="400" x2="0" y2="400" />
  </svg>
</template>
...
.line-floor {
  ...
  animation: line-2 500ms linear infinite;
}
